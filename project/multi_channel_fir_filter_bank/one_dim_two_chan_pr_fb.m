%%% FILTER ORDER 7 %%%
pr_fb_order = 7; %Filter Length
n = 0:1:1024;
f_low = 0.2*pi; %unique low frequency for testing
f_high = 0.7*pi; %unique high frequency for testing
f_p = 0.4; %low pass cut off
