...
x_ll_hh_temp = 0.25*(demod_exp_down_oct).*((demod_exp_down_oct).*conv2(h1_oct,h1_oct,x_ll_n))';
x_ll_lh_temp = 0.25*(demod_exp_down_oct).*conv2(h1_oct,h0_oct,x_ll_n)';
x_ll_hl_temp = 0.25*(demod_exp_down_oct).*conv2(h0_oct,h1_oct,x_ll_n);
...
%Decimate all bands except LL-LL
x_ll_hh_n = x_ll_hh_n.*0;
x_ll_lh_n = x_ll_lh_n.*0;
x_ll_hl_n = x_ll_hl_n.*0;
...
print -depsc pr_fb_oct_decimated_upsampling_modulation
